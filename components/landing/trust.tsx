      ...
      <div className="mx-auto max-w-6xl rounded-3xl border border-border/70 bg-card/70 px-5 py-6 shadow-lg shadow-primary/5 sm:px-8 sm:py-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Ils designent avec GenPost</p>
            <p className="text-sm text-muted-foreground">Studios, agences et créateurs qui publient chaque jour.</p>
          </div>
